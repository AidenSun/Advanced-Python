...
def countryMatch(d):
    ...
    while first_letter.upper() not in d:
        first_letter = input('Invalid entry. Re-enter the first letter of country name: ')    
...
def countryParticipate(sportsList, cur):
    sportName = input("Enter sport name: ").title()     #.title() in case the user types in all lowercase, all uppercase, or a combination of both
